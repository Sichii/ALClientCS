...
/// <summary>
///     Represent an object that is mutable.
///     <br />
///     <b>
...
/// <summary>
///     An object that is mutated by <typeparamref name="TMutator" />.
///     <br />
///     This exists to create a self-documenting pattern of interactions between objects.
///     <br />
///     <b>
///         Anything that inherits from this should implement <see cref="IEquatable{T}" />
///     </b>
...
public interface IMutable<in TMutator> : IMutable
{
    ...
    /// </summary>
    /// <param name="mutator">
    ///     The object containing information used to mutate this object.
    /// </param>
