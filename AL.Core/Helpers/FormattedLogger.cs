...
/// </summary>
public sealed class FormattedLogger : IFormattedLogger
{
    ...
    public void Fatal(object message) => Logger.Fatal($"[{Prefix}]{Environment.NewLine}{message}{Environment.NewLine}");
