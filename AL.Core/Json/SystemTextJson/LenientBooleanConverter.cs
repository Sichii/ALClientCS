...
///         Convert.ToBoolean
///     </c>
///     semantics (non-zero → true) on both its populate and direct paths. The server sends several boolean fields as
///     <c>
///         0
///     </c>
///     /
...
///         success
///     </c>
///     ). Registered in the shared options so it applies on the direct socket path too; a property-level converter (e.g.
///     AfkConverter for the bool-or-gravestone-name RIP field) still wins over it.
/// </summary>
