    ...
    public class ArrayToTupleConverter<T1, T2, T3, T4, T5> : JsonConverter<ValueTuple<T1?, T2?, T3?, T4?, T5?>>
    {
            ...
            JsonSerializer serializer)
        {
            ...
            return arr == null
                ...
                : arr.Count switch
                {
                    1 => new ValueTuple<T1?, T2?, T3?, T4?, T5?>(arr[0].ToObject<T1>(serializer), default, default,
                        default, default),
        ...
        ArrayToTupleConverter<T1, T2, T3, T4, T5, T6, T7> : JsonConverter<ValueTuple<T1?, T2?, T3?, T4?, T5?, T6?, T7?>>
    {
            ...
            JsonSerializer serializer)
        {
            ...
            return arr == null
                ...
                : arr.Count switch
                {
                    1 => new ValueTuple<T1?, T2?, T3?, T4?, T5?, T6?, T7?>(arr[0].ToObject<T1>(serializer), default,
