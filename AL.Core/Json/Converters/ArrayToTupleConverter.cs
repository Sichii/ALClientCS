...
public sealed class ArrayToTupleConverter<T1, T2> : JsonConverter<ValueTuple<T1?, T2?>>
{
        ...
        JsonSerializer serializer)
    {
        ...
        return arr == null
            ...
            : arr.Count switch
            {
                1 => new ValueTuple<T1?, T2?>(
                    arr[0]
                        .ToObject<T1>(serializer),
                    default),
                2 => new ValueTuple<T1?, T2?>(
                    arr[0]
                        .ToObject<T1>(serializer),
                    arr[1]
                        .ToObject<T2>(serializer)),
                _ => default
            };
    }
...
public sealed class ArrayToTupleConverter<T1, T2, T3> : JsonConverter<ValueTuple<T1?, T2?, T3?>>
{
        ...
        JsonSerializer serializer)
    {
        ...
        return arr == null
            ...
            : arr.Count switch
            {
                1 => new ValueTuple<T1?, T2?, T3?>(
                    arr[0]
                        .ToObject<T1>(serializer),
                    default,
                    default),
                2 => new ValueTuple<T1?, T2?, T3?>(
                    arr[0]
                        .ToObject<T1>(serializer),
                    arr[1]
                        .ToObject<T2>(serializer),
                    default),
                3 => new ValueTuple<T1?, T2?, T3?>(
                    arr[0]
                        .ToObject<T1>(serializer),
                    arr[1]
                        .ToObject<T2>(serializer),
                    arr[2]
                        .ToObject<T3>(serializer)),
                _ => default
            };
    }
...
public class ArrayToTupleConverter<T1, T2, T3, T4> : JsonConverter<ValueTuple<T1?, T2?, T3?, T4?>>
{
        ...
        JsonSerializer serializer)
    {
        ...
        return arr == null
            ...
            : arr.Count switch
            {
                1 => new ValueTuple<T1?, T2?, T3?, T4?>(
                    arr[0]
                        .ToObject<T1>(serializer),
                    default,
                    default,
                    default),
                2 => new ValueTuple<T1?, T2?, T3?, T4?>(
                    arr[0]
                        .ToObject<T1>(serializer),
                    arr[1]
                        .ToObject<T2>(serializer),
...
public sealed class ArrayToTupleConverter<T1, T2, T3, T4, T5> : JsonConverter<ValueTuple<T1?, T2?, T3?, T4?, T5?>>
{
        ...
        JsonSerializer serializer)
    {
        ...
        return arr == null
            ...
            : arr.Count switch
            {
                1 => new ValueTuple<T1?, T2?, T3?, T4?, T5?>(
                    arr[0]
                        .ToObject<T1>(serializer),
                    default,
                    default,
                    default,
                    default),
                2 => new ValueTuple<T1?, T2?, T3?, T4?, T5?>(
                    arr[0]
                        .ToObject<T1>(serializer),
                    arr[1]
                        .ToObject<T2>(serializer),
                    ...
                    default,
                    default),
                3 => new ValueTuple<T1?, T2?, T3?, T4?, T5?>(
                    arr[0]
                        .ToObject<T1>(serializer),
                    arr[1]
                        .ToObject<T2>(serializer),
                    ...
                    default,
                    default),
                4 => new ValueTuple<T1?, T2?, T3?, T4?, T5?>(
                    arr[0]
                        .ToObject<T1>(serializer),
                    arr[1]
                        .ToObject<T2>(serializer),
                    ...
                    arr[3]
                        .ToObject<T4>(serializer),
                    default),
                5 => new ValueTuple<T1?, T2?, T3?, T4?, T5?>(
                    arr[0]
                        .ToObject<T1>(serializer),
                    arr[1]
                        .ToObject<T2>(serializer),
...
public class ArrayToTupleConverter<T1, T2, T3, T4, T5, T6> : JsonConverter<ValueTuple<T1?, T2?, T3?, T4?, T5?, T6?>>
{
        ...
        JsonSerializer serializer)
    {
        ...
        return arr == null
            ...
            : arr.Count switch
            {
                1 => new ValueTuple<T1?, T2?, T3?, T4?, T5?, T6?>(
                    arr[0]
                        .ToObject<T1>(serializer),
                    default,
                    default,
                    ...
                    default,
                    default),
                2 => new ValueTuple<T1?, T2?, T3?, T4?, T5?, T6?>(
                    arr[0]
                        .ToObject<T1>(serializer),
                    arr[1]
                        .ToObject<T2>(serializer),
                    ...
                    default,
                    default),
                3 => new ValueTuple<T1?, T2?, T3?, T4?, T5?, T6?>(
                    arr[0]
                        .ToObject<T1>(serializer),
                    arr[1]
                        .ToObject<T2>(serializer),
                    ...
                    default,
                    default),
                4 => new ValueTuple<T1?, T2?, T3?, T4?, T5?, T6?>(
                    arr[0]
                        .ToObject<T1>(serializer),
                    arr[1]
                        .ToObject<T2>(serializer),
                    ...
                    default,
                    default),
                5 => new ValueTuple<T1?, T2?, T3?, T4?, T5?, T6?>(
                    arr[0]
                        .ToObject<T1>(serializer),
                    arr[1]
                        .ToObject<T2>(serializer),
                    ...
                    arr[4]
                        .ToObject<T5>(serializer),
                    default),
                6 => new ValueTuple<T1?, T2?, T3?, T4?, T5?, T6?>(
                    arr[0]
                        .ToObject<T1>(serializer),
                    arr[1]
                        .ToObject<T2>(serializer),
...
public class ArrayToTupleConverter<T1, T2, T3, T4, T5, T6, T7> : JsonConverter<ValueTuple<T1?, T2?, T3?, T4?, T5?, T6?, T7?>>
{
        ...
        JsonSerializer serializer)
    {
        ...
        return arr == null
            ...
            : arr.Count switch
            {
                1 => new ValueTuple<T1?, T2?, T3?, T4?, T5?, T6?, T7?>(
                    arr[0]
                        .ToObject<T1>(serializer),
                    default,
                    default,
                    ...
                    default,
                    default),
                2 => new ValueTuple<T1?, T2?, T3?, T4?, T5?, T6?, T7?>(
                    arr[0]
                        .ToObject<T1>(serializer),
                    arr[1]
                        .ToObject<T2>(serializer),
                    ...
                    default,
                    default),
                3 => new ValueTuple<T1?, T2?, T3?, T4?, T5?, T6?, T7?>(
                    arr[0]
                        .ToObject<T1>(serializer),
                    arr[1]
                        .ToObject<T2>(serializer),
                    ...
                    default,
                    default),
                4 => new ValueTuple<T1?, T2?, T3?, T4?, T5?, T6?, T7?>(
                    arr[0]
                        .ToObject<T1>(serializer),
                    arr[1]
                        .ToObject<T2>(serializer),
                    ...
                    default,
                    default),
                5 => new ValueTuple<T1?, T2?, T3?, T4?, T5?, T6?, T7?>(
                    arr[0]
                        .ToObject<T1>(serializer),
                    arr[1]
                        .ToObject<T2>(serializer),
                    ...
                    default,
                    default),
                6 => new ValueTuple<T1?, T2?, T3?, T4?, T5?, T6?, T7?>(
                    arr[0]
                        .ToObject<T1>(serializer),
                    arr[1]
                        .ToObject<T2>(serializer),
                    ...
                    arr[5]
                        .ToObject<T6>(serializer),
                    default),
                7 => new ValueTuple<T1?, T2?, T3?, T4?, T5?, T6?, T7?>(
                    arr[0]
                        .ToObject<T1>(serializer),
                    arr[1]
                        .ToObject<T2>(serializer),
