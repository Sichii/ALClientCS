...
public static class FloatingPointExtensions
{
    ...
    public static bool IsGreaterOrEqual(this double a, double b, double epsilon = 0.0000001) => (a == b) || a.IsGreater(b, epsilon);

    // ReSharper disable once CompareOfFloatsByEqualityOperator
    public static bool IsGreaterOrEqual(this float a, float b, float epsilon = 0.0000001f) => (a == b) || a.IsGreater(b, epsilon);
    ...
    // ReSharper disable once CompareOfFloatsByEqualityOperator
    public static bool IsLessOrEqual(this double a, double b, double epsilon = 0.0000001) => (a == b) || a.IsLess(b, epsilon);

    // ReSharper disable once CompareOfFloatsByEqualityOperator
    public static bool IsLessOrEqual(this float a, float b, float epsilon = 0.0000001f) => (a == b) || a.IsLess(b, epsilon);
