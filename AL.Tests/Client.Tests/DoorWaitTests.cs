...
/// <summary>
///     A bank door is answered "in progress" and lands seconds later, once the server has loaded the bank. These hold the
///     wait that answer extends, and the magiport refusal that rides on it.
/// </summary>
