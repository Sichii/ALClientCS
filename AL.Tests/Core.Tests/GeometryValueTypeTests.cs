...
public class GeometryValueTypeTests
{
    ...
    public void GenericDistanceWorksOnRefStructs()
    {
        ...
        new Point(0, 0).Distance(new Location("main", 6, 8))
                       .Should()
                       .Be(10);
    }
    ...
    public void GenericEdgeDistancesWorkOnRefStructs()
    {
        ...
        rectangle.EdgeToCenterDistance(new ValuePoint(8, 0))
                 .Should()
                 .Be(3);

        rectangle.EdgeToCenterDistance(new ValuePoint(0, 0))
                 .Should()
                 .Be(0);

        rectangle.EdgeToCenterDistance(new Point(8, 14))
                 .Should()
                 .Be(5);

        rectangle.EdgeToEdgeDistance(
                     new ValueRectangle(
                         20,
                         0,
                         10,
        ...
        circle.EdgeToCenterDistance(new ValuePoint(8, 0))
              .Should()
              .Be(3);

        circle.EdgeToEdgeDistance(new Circle(12, 0, 2))
              .Should()
              .Be(5);

        circle.Intersects(new ValueCircle(9, 0, 4))
              .Should()
              .BeTrue();
        ...
        circle.GenerateCircumferencePoints(4)
              .Should()
              .HaveCount(4);
    }
    ...
    public void GenericLocationChecksWorkOnRefStructs()
    {
        ...
        value.OnSameMapAs(new Location("MAIN", 5, 5))
             .Should()
             .BeTrue();

        value.OnSameMapAs(new ValueLocation("cave", 5, 5))
             .Should()
             .BeFalse();

        value.DistanceWithMapCheck(new Location("main", 3, 4))
             .Should()
             .Be(5);

        value.DistanceWithMapCheck(new Location("cave", 3, 4))
             .Should()
             .Be(float.MaxValue);

        value.ToLocation()
             .Should()
             .Be(new Location("main", 0, 0));
    }
    ...
    public void RayTraceVisitsEveryCellTheLineCrosses()
    {
        ...
        for (var i = 1; i < diagonal.Length; i++)
            (Math.Abs(diagonal[i].X - diagonal[i - 1].X) + Math.Abs(diagonal[i].Y - diagonal[i - 1].Y)).Should()
                .Be(1);
    }
    ...
    public void ValueCircleCarriesRadius()
    {
        ...
        value.Equals((ICircle)circle)
             .Should()
             .BeTrue();

        value.Equals((ICircle)new Circle(1, 1, 8))
             .Should()
             .BeFalse();
    }
    ...
    public void ValueLocationKeepsMapAndComparesMapCaseInsensitively()
    {
        ...
        value.Equals((ILocation)new Location("MAIN", 3, 4))
             .Should()
             .BeTrue();

        value.Equals((ILocation)new Location("cave", 3, 4))
             .Should()
             .BeFalse();
    }
    ...
    public void ValueLocationWithNullMapDoesNotThrow()
    {
        ...
        value.Equals((ILocation)new Location("main", 0, 0))
             .Should()
             .BeFalse();
