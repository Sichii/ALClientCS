...
{
    /// <summary>
    ///     An L: the vertical bar x 0..20, y 0..70 and the horizontal bar x 0..50, y 50..70. Four triangles in a
    ///     chain, T0 at the bottom of the bar, T3 at the end of the arm. The straight line from (10, 10) to (45, 60)
    ///     leaves the L, so the pull has to bend at the inner corner (20, 50).
    /// </summary>
    ...
    {
        var path = new List<Point> { new(-1, -1) };
