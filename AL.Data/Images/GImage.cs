...
/// </summary>
/// <remarks>
///     A sheet carries the grid it is cut into but not the size of the file that grid covers, so this is what turns a row
///     and a column into pixels. Only the character and monster sheets need it - an item sheet states its own icon size.
/// </remarks>
