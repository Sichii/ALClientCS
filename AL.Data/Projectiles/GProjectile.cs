...
{
    /// <summary>
    ///     Cosmetic only: the sprite is drawn without the attacker's weapon glow tint (js/game.js:2820). Only the snowball
    ///     carries it.
    /// </summary>
    ...
    ///     instead of a sprite that travels (js/game.js:2823).
    /// </summary>
    ...
    ///     edge-to-edge distance divided by this (node/server.js:3254).
    /// </summary>
