...
/// <summary>
///     Represents a point on a graph , with zero or more edges. Inherits from <see cref="FastPriorityQueueNode" /> for use
///     in <see cref="FastPriorityQueue{T}" />.
/// </summary>
public sealed class GraphNode : FastPriorityQueueNode, IGraphNode<GraphEdge>
{
