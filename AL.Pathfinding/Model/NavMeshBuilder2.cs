...
namespace AL.Pathfinding.Model
{
    public class NavMeshBuilder2
    {
        ...
        public NavMeshBuilder2(GMap map, GGeometry geometry)
        {
            Map = map;
            Geometry = geometry;
        ...
        public NavMesh2 Build()
        {
            ...
            return new NavMesh2(Map.Accessor, meshTriangles, PointMap, XOffset, YOffset);
        }
