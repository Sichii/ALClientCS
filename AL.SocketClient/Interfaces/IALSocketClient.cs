...
public interface IALSocketClient : IAsyncDisposable
{
    ...
    /// </summary>
    /// <param name="server">
    ///     An object containing information about the server to connect to. Use the <see cref="APIClient" /> to get this
    ///     information.
    /// </param>
    Task ConnectAsync(Server server);

    /// <summary>
    ///     Asynchronously disconnects this client from the server.
    ///     <br />
    ...
    /// <summary>
    ///     Instructs the client on how to handle a certain message type.
    ///     <br />
    ...
    /// </param>
    /// <typeparam name="T">
    ///     The type of data to expect and deserialize when receiving the message.
    /// </typeparam>
    /// <returns>
    ///     A disposable object that when disposed will remove this handler from the handler list.
    ///     <br />
