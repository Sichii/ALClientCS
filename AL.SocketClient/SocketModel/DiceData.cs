...
public sealed record DiceData
{
    ...
    /// <summary>
    ///     The commit hash for the coming roll, on a <c>bets</c> frame.
    /// </summary>
    [JsonPropertyName("hex")]
    public string? Hex { get; init; }

    /// <summary>
    ///     The other half of the fairness reveal, on a <c>lock</c> frame.
    /// </summary>
    [JsonPropertyName("key")]
    public string? Key { get; init; }

    /// <summary>
    ///     The rolled number, on a <c>lock</c> frame only. Runs from 00.00 to 99.99.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    ///     Half of the fairness reveal, on a <c>lock</c> frame.
    /// </summary>
