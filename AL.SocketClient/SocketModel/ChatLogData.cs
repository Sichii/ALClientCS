...
/// <summary>
///     Represents an inbound public chat line. A player's own chat goes out through
///     <c>
///         broadcast
///     </c>
///     , which is a bare
...
///         io.emit
///     </c>
///     (node/server.js:4638, node/server_functions.js:2929) - so this reaches every socket on the server rather than only
///     the ones nearby, and the sender receives their own line back. The outbound half is
///     <c>
///         SayAsync
///     </c>
///     .
/// </summary>
/// <remarks>
///     Not every line comes from a player. The same event carries NPC and system chatter through
///     <c>
///         xy_emit
///     </c>
///     - the pvp arena's kill announcements, the Grinch's phrases, cyberland's mainframe - and those are local to the area
///     rather than server-wide. <see cref="IsPlayerChat" /> is what tells them apart.
/// </remarks>
