...
namespace AL.SocketClient.SocketModel
{
    ...
    public record HitData
    {
        ...
        /// <summary>
        ///     The amount of damage returned to the attacker from this hit. <br />
        ///     DReturn is <see cref="AL.Core.Definitions.DamageType.Physical" /> damage only,
        ///     and this number ignores the source entity's armor because this number results from calculating damage on the target
        ///     entity using it's armor.
        /// </summary>
        ...
        /// <summary>
        ///     Whether or not the attack missed. <br />
        ...
        /// <summary>
        ///     The amount of damage returned to the attacker from this hit. <br />
        ///     Reflect is for <see cref="AL.Core.Definitions.DamageType.Magical" /> damage only,
        ///     and this number ignores the source entity's resistance because this number results from calculating damage on the
        ///     target entity using it's resistance.
        /// </summary>
