...
///     <c>IReadOnlyList&lt;Item?&gt;</c> with a single constructor taking its backing list; System.Text.Json
///     would otherwise route it to the collection converter and fail to instantiate it ("collection type is
///     read only"). Newtonsoft used the type's <c>[JsonConstructor]</c>. Reads the array as a
///     <c>List&lt;Item?&gt;</c> and hands it to the constructor; <c>Character.OnDeserialized</c> later sizes it.
/// </summary>
