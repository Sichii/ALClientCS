...
///     replacement for the Newtonsoft <c>EventAndBossDataConverter</c> . Register in the shared options so the
///     declared-field fill drops this converter and cannot re-enter itself.
/// </summary>
