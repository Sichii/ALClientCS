...
public sealed record Prediction : IOptionalObject
{
    ...
    /// <summary>
    ///     True once the roll is revealed to succeed. Like <see cref="Failure" /> it is published ahead of the result itself -
    ///     with 22% of the animation left, capped at 2.2s - so it is false both before the reveal and on an attempt that is
    ///     going to fail.
    /// </summary>
