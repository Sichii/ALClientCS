...
public class Character : Player, IEquatable<Character>
{
    ...
    /// <summary>
    ///     The number of pure-damage monsters this character can face before gaining fear. Pure only - a physical attacker
    ///     counts against <see cref="Courage" /> instead.
    /// </summary>
