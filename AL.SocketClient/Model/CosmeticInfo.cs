...
/// </summary>
/// <remarks>
///     Nine of the ten slots are the non-
///     <c>
///         skin
///     </c>
///     values of the server's
///     <c>
///         cxtype_to_slot
///     </c>
///     map (js/old_common_functions.js:135).
///     <c>
///         upper
///     </c>
///     is the tenth and appears in no such map: the server writes it from a branch of its own (node/server.js:4849), and
///     only for a body or armor sprite. A body, armor or character sprite sent to the
///     <c>
///         skin
///     </c>
///     slot writes
...
///         player.skin
///     </c>
///     instead of anything here, and arrives as <see cref="Player.Skin" />.
///     <br />
...
public sealed class CosmeticInfo
{
    ...
    /// <summary>
    ///     A body or armor sprite worn over the base skin.
    /// </summary>
