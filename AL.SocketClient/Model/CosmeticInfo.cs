...
///     (js/old_common_functions.js:135). <c>upper</c> is the tenth and appears in no such map: the server writes it from a
///     branch of its own (node/server.js:4849), and only for a body or armor sprite. A body, armor or character sprite
///     sent to the <c>skin</c> slot writes <c>player.skin</c> instead of anything here, and arrives as
///     <see cref="Player.Skin" />.
///     <br />
