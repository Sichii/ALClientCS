...
namespace AL.Visualizer
{
    ...
    public static class Visualizer
    {
        ...
        /// An image representing the map. It's not exact (it doesnt use tiles), but it gives you a useable 1 to 1 visualization. <br/>
        /// You can use <see cref="Extensions.ImageExtensions"/> to layer on more information about the <see cref="NavMesh"/>.</returns>
