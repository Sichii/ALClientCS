...
public class Mage : ALClient
{
    ...
    /// </summary>
    /// <param name="characterName">The name of the mage.</param>
    ...
    /// </summary>
    /// <exception cref="InvalidOperationException">Failed to use 'alchemy'. ({reason})</exception>
    ...
    /// <exception cref="InvalidOperationException">Failed to use 'blink'. ({reason})</exception>
    ...
    /// </returns>
    /// <exception cref="ArgumentNullException">targetId</exception>
    /// <exception cref="InvalidOperationException">Failed to use 'burst' on {targetId}. ({reason})</exception>
    ...
    /// </param>
    /// <exception cref="ArgumentNullException">targets</exception>
    /// <exception cref="InvalidOperationException">Failed to use 'cburst'. ({reason})</exception>
