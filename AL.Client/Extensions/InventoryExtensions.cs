...
public static class InventoryExtensions
{
    ...
    ///         true
    ///     </c>
    ///     if an item with the name was found, otherwise
    ///     <c>
    ///         false
    ///     </c>
    ///     .
    ...
    ///     <br />
    ///     The item, and informaiton about what slot it is in, or
    ///     <c>
    ///         null
    ///     </c>
    ...
    /// </param>
    /// <param name="levelMin">
    ///     The item must have at least this level.
    /// </param>
    /// <param name="levelMax">
    ///     The item must have at most this level.
    /// </param>
    /// <param name="quantityMin">
    ///     The item must have a minimum of this quantity.
    /// </param>
    /// <param name="quantityMax">
    ///     The item must have a maximum of this quantity.
    /// </param>
    /// <returns>
    ///     <see cref="InventoryIndexer" />
    ///     <br />
    ...
    ///         add_item
    ///     </c>
    ///     places a non-stackable unequip in the first free slot, while an equip in flight on the same socket swaps in place -
    ///     the item it displaces lands in the occupied slot the replacement vacated. Requiring a previously-empty slot is what
    ///     tells those apart when both hands wear the same weapon at the same level, and it also skips a spare copy already
    ///     sitting in a lower slot. The fallback answers for a stackable merged onto an existing pile, which lands on no empty
    ///     slot at all.
    /// </remarks>
    /// <exception cref="ArgumentNullException">
    ///     inventory
