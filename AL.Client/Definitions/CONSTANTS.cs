...
public static class CONSTANTS
{
    ...
    /// </summary>
    /// <remarks>
    ///     This is a composite and looks wrong at a glance. The server values the item at <c>g * buy_to_sell</c> (0.6) and
    ///     then applies a 2x second-hands multiplier, so the price really is 1.2x the base value. Do not "correct" this to 2.
    /// </remarks>
    public const float PONTY_MARKUP = 1.2f;

    /// <summary>The same, for cash-shop items.</summary>
    /// <remarks>
